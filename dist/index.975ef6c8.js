...
(0, _model.model).forEach((block)=>{
    const toHTML = (0, _templates.template)[block.type];
    if (toHTML) $wrapper.insertAdjacentHTML("beforeend", toHTML(block));
});

},{"./model":"dEDha","./templates":"gOO7a","./styles.css":"lW6qc"}],"dEDha":[function(require,module,exports) {
